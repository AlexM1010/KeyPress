	...
	<div class="grid gap-6">
		...
		<div class="grid gap-6 auto-rows-min">
			<div class="flex flex-wrap justify-between items-center gap-2">
				<NumberInput label="Clicks" bind:value={data.numberOfClicks} minValue={0} maxValue={1000} />
			...
			<div class="flex flex-wrap justify-between items-center gap-2">
				<Checkbox label="Release" bind:checked={data.releaseAfterPress} {highlightColor} />
